...
$fav_target="streamm4u_s_fav.php?host=".$last_good;
$add_target="streamm4u_s_add.php";
$add_file="";
$fs_target="streamm4u_ep.php";
$target="streamm4u_s.php";
/* ==================================================== */
