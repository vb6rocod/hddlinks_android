...
echo '<TR><th class="cat"  colspan="3">
filmeonline2019</Th></TR>';
echo '<TR><TD class="cat">'.'<a href="filmeonline2019.php?page=1&tip=release&link=https://filmeonline2019.us/filme-online&title=Recente" target="_blank">Recente</a></TD>
<TD class="form" colspan="2"><form action="filmeonline2019.php" target="_blank">
...
foreach($videos as $video) {
    ...
    $t3 = explode('<', $t2[1]);
    $title = $t3[0];
    $link="filmeonline2019.php?page=1&tip=release&link=".$link."&title=".urlencode($title);
    if (!preg_match("/\#|contact|imdb/i",$link)) {
	if ($n == 0) echo "<TR>"."\n\r";
