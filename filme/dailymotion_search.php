...
echo '<table border="1px" width="100%">'."\n\r";
if ($tip=="video")
 $l="https://api.dailymotion.com/videos?search=".str_replace(" ","%20",$search)."&fields=duration%2Cid%2Cdescription%2Cowner%2Cowner.id%2Cthumbnail_480_url%2Ctitle&limit=25&longer_than=5&page=".$page;
else
 $l="https://api.dailymotion.com/playlists?fields=id%2Cdescription%2Cowner.playlists_total%2Citem_type%2Cthumbnail_480_url%2Cvideos_total%2Cname%2Cowner%2Cowner.id&limit=25&search=".str_replace(" ","%20",$search)."&page=".$page;
//echo $l;
  ...
  if ($tip=="video")  {
   ...
   $dur="";
  $add_fav="mod=add&kind=".$tip."&id=".$id."&title=".urlencode(fix_t($title))."&image=".$image;
