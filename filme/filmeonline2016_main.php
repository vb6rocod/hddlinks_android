...
echo '<TR><TD class="cat">'.'<a class ="nav" href="filmeonline2016.php?page=1&tip=release&link=http://www.filmeonline2016.biz/&title=Recente" target="_blank">Recente...</a></TD>';
echo $form;
echo '</TR>';
$n=0;
