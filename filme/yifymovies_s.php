...
$has_add="yes";
$has_fs="yes";
$fav_target="yifymovies_s_fav.php?host=https://yifymovies.tv";
$add_target="yifymovies_s_add.php";
$add_file="";
$fs_target="yifymovies_s_ep.php";
$target="yifymovies_s.php";
/* ==================================================== */
...
if($tip=="release") {
  if ($page > 1)
  $l="https://yifymovies.tv/series/page/".$page."/";
  else
  $l="https://yifymovies.tv/series/";
} else {
