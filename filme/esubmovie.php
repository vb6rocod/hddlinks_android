...
$has_add="yes";
$has_fs="no";
$fav_target="esubmovie_fav.php?host=https://esubmovie.com";
$add_target="esubmovie_add.php";
$add_file="";
$fs_target="";
$target="esubmovie.php";
/* ==================================================== */
...
if($tip=="release") {
 if ($page>1)
  $l ="https://esubmovie.com/page/".$page."/";
 else
  $l="https://esubmovie.com/";
} else {
  $search=str_replace(" ","+",$tit);
  if ($page == 1)
    $l="https://esubmovie.com/?s=".$search;
  else
    $l="https://esubmovie.com/page/".$page."/?s=".$search;
}
$r=array();
