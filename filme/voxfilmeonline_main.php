...
if (file_exists($base_cookie."filme.dat"))
  ...
  $val_search="";
$form='<TD class="form" colspan="2"><form action="voxfilmeonline.php" target="_blank">
...
echo '<TR><th class="cat" colspan="3">voxfilmeonline</th></TR>';
echo '<TR><TD class="cat">'.'<a class ="nav" href="voxfilmeonline.php?page=1&tip=release&link=https://voxfilmeonline.net/&title=Recente" target="_blank">Recente...</a></TD>';
echo $form;
echo '</TR>';
$n=0;
...
foreach($videos as $video) {
    ...
    $t3 = explode('<', $t2[1]);
    $title = $t3[0];
    $link="voxfilmeonline.php?page=1&tip=release&link=".$link."&title=".urlencode($title);
