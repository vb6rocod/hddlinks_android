...
$has_add="yes";
$has_fs="yes";
$fav_target="filmeonlinegratis_s_fav.php?host=https://filmeonlinegratis.org";
$add_target="filmeonlinegratis_s_add.php";
$add_file="";
$fs_target="filmeonlinegratis_ep.php";
$target="filmeonlinegratis_s.php";
/* ==================================================== */
...
if ($tip == "release")
   if ($page > 1)
    $l="https://filmeonlinegratis.org/seriale-online/page/".$page."/";
   else
    $l="https://filmeonlinegratis.org/seriale-online/";
else {
