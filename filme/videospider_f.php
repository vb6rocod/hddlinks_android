...
$width="200px";
$height="278px";
$add_target="videospider_f_add.php";
$fs_target="videospider_fs.php";
$file=$base_fav."videospider_f.dat";
$fav_target_fix="videospider_f.php?fix=yes";
...
foreach($arr as $key => $value) {
    ...
    if (preg_match("/404 Not Found|Content\-Type\: text\/html/",$x)) {
      ...
      $l="https://api.themoviedb.org/3/movie/".$link."?api_key=".$api_key;
      //echo $l;
      $ch = curl_init($l);
