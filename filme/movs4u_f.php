...
$has_add="yes";
$has_fs="yes";
$fav_target="movs4u_f_fav.php?host=https://www.movs4u.live";
$add_target="movs4u_f_add.php";
$add_file="";
$fs_target="movs4u_fs.php";
$target="movs4u_f.php";
/* ==================================================== */
...
if($tip=="release") {
  if ($page > 1)
  $l="https://www.movs4u.live/movie/page/".$page."/";
  else
  $l="https://www.movs4u.live/movie/";
} else {
