...
$has_add="yes";
$has_fs="yes";
$fav_target="rovideo_fav.php?host=https://www.rovideo.net";
...
Cautare :  <input type="text" id="title" name="title" value="'.$val_search.'">
...
$ua = $_SERVER['HTTP_USER_AGENT'];
  ...
  foreach($videos as $video) {
    ...
    $t2=explode('<',$t1[1]);
    $durata=$t2[0];
    array_push($r ,array($title,$link, $image,$durata));
  }
$c=count($r);
for ($k=0;$k<$c;$k++) {
  $title=$r[$k][0];
