...
echo '<TR><th class="cat" colspan="3">cineplex</Th></TR>';
...
';
echo '<TD class="form" colspan="2"><form action="cineplex_s.php" target="_blank">
...
';
$gen="";
$link="cineplex_s.php?tip=release&page=1&gen=".$gen."&token=".$token."&title=Recente";
$title="Recente";
...
$n=1;
  ...
  foreach($videos as $video) {
    ...
    $t4=explode('<',$t3[2]);
    $title=$t4[0];
    $link="cineplex_s.php?tip=release&page=1&gen=".$gen."&token=".$token."&title=".$title;
    if ($n==0) echo '<TR>';
