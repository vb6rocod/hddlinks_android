...
if($tip=="release") {
 if ($page>1)
  $l ="https://www.dozaanimata.ro/genre/filme/page/".$page."/";
 else
  $l="https://www.dozaanimata.ro/genre/filme/";
} else {
  $search=str_replace(" ","+",$tit);
  if ($page == 1)
    $l="https://www.dozaanimata.ro/?s=".$search;
  else
    $l="https://www.dozaanimata.ro/page/".$page."/?s=".$search;
}
$r=array();
$ua = $_SERVER['HTTP_USER_AGENT'];
  ...
  foreach($videos as $video) {
    ...
    $t2=explode('"',$t1[1]);
    $link="https://www.dozaanimata.ro".$t2[0];
    $t1=explode('alt="',$video);
    $t2=explode('"',$t1[1]);
    $title=trim($t2[0]);
    $t1=explode('data-original="',$video);
    $t2=explode('"',$t1[1]);
    $image="https://www.dozaanimata.ro".$t2[0];
