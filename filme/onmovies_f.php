...
$has_add="yes";
$has_fs="yes";
$fav_target="onmovies_f_fav.php?host=https://yifymovies.fun";       //https://yifymovies.fun https://onmovies.se
$add_target="onmovies_f_add.php";
$add_file="";
$fs_target="onmovies_fs.php";
$target="onmovies_f.php";
/* ==================================================== */
...
if($tip=="release") {
  $l ="https://yifymovies.fun/movie/filter/movie/all/all/all/all/latest/?page=".$page;
} else {
