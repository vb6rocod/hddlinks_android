...
$has_add="yes";
$has_fs="yes";
$fav_target="putlockerfit_s_fav.php?host=https://www.putlocker.fyi";
$add_target="putlockerfit_s_add.php";
$add_file="";
$fs_target="putlockerfit_ep.php";
$target="putlockerfit_s.php";
/* ==================================================== */
...
if($tip=="release") {
  $l="https://www.putlocker.fyi/a-z-shows/page/".$page."/";
} else {
