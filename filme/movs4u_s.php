...
$has_add="yes";
$has_fs="yes";
$fav_target="movs4u_s_fav.php?host=https://www.movs4u.live";
$add_target="movs4u_s_add.php";
$add_file="";
$fs_target="movs4u_s_ep.php";
$target="movs4u_s.php";
/* ==================================================== */
...
if($tip=="release") {
  if ($page > 1)
  $l="https://www.movs4u.live/tvshows/page/".$page."/";
  else
  $l="https://www.movs4u.live/tvshows/";
} else {
  $search=str_replace(" ","+",$tit);
  $l="https://www.movs4u.live/page/".$page."/?s=".$search;
}
///////////////////////////////////////////////////////////////////////////
$requestLink=$l;
