...
$has_add="yes";
$has_fs="yes";
$fav_target="123stream_s_fav.php?host=".$last_good;
$add_target="123stream_s_add.php";
$add_file="";
$fs_target="123stream_ep.php";
$target="123stream_s.php";
/* ==================================================== */
...
foreach($videos as $video) {
  ...
  $imdb="";
  $link_f=$fs_target.'?tip=series&link='.urlencode($link).'&title='.urlencode(fix_t($title)).'&image='.$image."&sez=&ep=&ep_tit=&year=".$year."&last=".$last_good;
  if ($title) {
  if ($n==0) echo '<TR>'."\r\n";
