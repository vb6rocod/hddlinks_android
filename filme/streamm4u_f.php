...
$has_add="yes";
$has_fs="yes";
$fav_target="streamm4u_f_fav.php?host=".$last_good;
$add_target="streamm4u_f_add.php";
$add_file="";
$fs_target="streamm4u_fs.php";
$target="streamm4u_f.php";
/* ==================================================== */
...
if ($tip=="search") {
 ...
 if ($page==1)
  $l=$last_good."/search/".$search;
 else
  $l=$last_good."/search/".$search."?page=".$page;
} else {
 if ($page==1)
  $l=$last_good."/new-movies";
 else
  $l=$last_good."/new-movies?page=".$page;
}
...
$videos = explode('<div class="col-xl', $h);
unset($videos[0]);
