...
$has_add="yes";
$has_fs="yes";
$fav_target="fshd_s_fav.php?host=".$last_good;
$fav_target_fix="fshd_s_fav.php?host=".$last_good;
...
if ($tip == "release") {
   if ($page > 1)
    $l=$last_good."/seriale-online-subtitrate/page/".$page;
   else
    $l=$last_good."/seriale-online-subtitrate/";
} else {
