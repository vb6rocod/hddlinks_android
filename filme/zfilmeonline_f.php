...
$width="200px";
$height="278px";
$last_good="https://www.zfilmeonline.ro";
...
echo '</TR>'."\r\n";
//https://www.zfilmeonline.ro/page/2

$host="www.zfilmeonline.ro";
if($tip=="release") {
 if ($page>1)
  ...
  if ($page > 1)
    ...
    $l="https://".$host."/?s=".$search."&paged=".$page;
}
//$l="https://www.zfilmeonline.ro/page/2";
//https://www.zfilmeonline.ro/?s=star
//https://www.zfilmeonline.ro/?s=star&paged=2
...
for ($k=0;$k<$c;$k++) {
  ...
  //$image="https://ttraian22.great-site.net/getlink1.php?link=".$image;
  //$image=getHTML1($image);
  $rest = substr($title, -2);
  //echo urlencode($rest);
