...
$has_add="yes";
$has_fs="yes";
$fav_target="emovies_f_fav.php?host=".$last_good;
$add_target="emovies_f_add.php";
$add_file="";
$fs_target="emovies_fs.php";
$target="emovies_f.php";
/* ==================================================== */
...
if ($tip=="search") {
 ...
 if ($page==1)
  $l=$last_good."/free-latest-movies-online";
 else
  $l=$last_good."/free-latest-movies-online/".$page;
}
