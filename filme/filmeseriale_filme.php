...
$w=0;
$n=0;
echo '<H2>'.$page_title.' Daca nu apar sursele apasa <a href="filmeseriale_f_captcha.php">aici.</a></H2>'."\r\n";
...
if($tip=="release") {
 if ($page>1)
  $l ="http://www.filmeserialeonline.org/filme-online-hd-2024-00/page/".$page."/";
 else
  $l="http://www.filmeserialeonline.org/filme-online-hd-2024-00/";
} else {
  $search=str_replace(" ","+",$tit);
  if ($page > 1)
     $l="http://www.filmeserialeonline.org/page/".$page."?s=".$search;
  else
     $l="http://www.filmeserialeonline.org/?s=".$search;
}
