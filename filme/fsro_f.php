...
$has_add="yes";
$has_fs="yes";
$fav_target="fsro_f_fav.php?host=".$last_good;
$add_target="fsro_f_add.php";
$add_file="";
$fs_target="fsro_fs.php";
$target="fsro_f.php";
/* ==================================================== */
...
if ($tip=="search") {
 ...
 if ($page==1)
  $l="https://".$host."/?s=".$search."&post_type=movie";
 else
  $l="https://".$host."/page/".$page."?s=".$search."&post_type=movie";
} else {
 if ($page==1)
  $l="https://".$host."/filme/";
 else
