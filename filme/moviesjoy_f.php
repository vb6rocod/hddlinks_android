...
function ajaxrequest(link) {
  ...
  var the_data = link;
  //alert(the_data);
  var php_file="moviesjoy_f_add.php";
...
echo '<a class="nav" href="moviesjoy_f.php?page='.($page-1).'&file='.$file.'&title='.urlencode($title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a class="nav" href="moviesjoy_f.php?page='.($page+1).'&file='.$file.'&title='.urlencode($title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
}else {
echo '<TR><TD class="cat"><a class "imdb" id="fav" href="moviesjoy_f_fav.php" target="blank">Favorite</a></TD>
<TD class="form" colspan="2">';
//echo '<TD colspan="2">';
//title=star&page=1&file=search
echo '<form action="moviesjoy_f.php" target="_blank">Cautare film:';
...
echo '<TD colspan="1" align="right"><a class="nav" href="moviesjoy_f.php?page='.($page+1).'&file='.$file.'&title='.urlencode($title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
}
}
...
foreach($videos as $video) {
  ...
  $t2 = explode('"', $t1[1]);
  $link1 = str_replace(".html","/watching.html",$t2[0]);
  ...
  $t2 = explode('"', $t1[1]);
  $image = $t2[0];
  $link2='moviesjoy_fs.php?tip=movie&link='.$link1.'&title='.urlencode(fix_t($title11)).'&image='.$image."&sez=&ep=&ep_tit=";

  if ($title11 && strpos($link1,"-season") === false) {
  if ($n==0) echo '<TR>';
...
echo '<a class="nav" href="moviesjoy_f.php?page='.($page+1).'&file='.$file.'&title='.urlencode($title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
}
echo "</table>";
?>
<br></div></body>
