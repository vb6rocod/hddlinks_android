...
$has_add="yes";
$has_fs="yes";
$fav_target="filmeseriale-hd_fav.php?host=https://filmeseriale-hd.com";
$add_target="filmeseriale-hd_add.php";
$add_file="";
$fs_target="filmeseriale-hd_ep.php";
$target="filmeseriale-hd.php";
/* ==================================================== */
...
if ($tip == "release")
  ...
  if ($page == 1)
    ...
    $l="https://filmeseriale-hd.com/page/".$page."/?s=".$search;
}
$r=array();
