...
if ($tip=="release") {
  $l="https://filmeseriale-hd.com/seriale/page/".$page."/";
  $ch = curl_init();
  ...
  $l="https://filmeseriale-hd.com/?s=".$search;
  $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, $l);
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
  curl_setopt($ch, CURLOPT_USERAGENT, 'Mozilla/5.0 (Windows NT 10.0; rv:55.0) Gecko/20100101 Firefox/55.0');
...
echo '<TD class="cat" width="25%"><a id="fav" a href="filmeseriale-hd_fav.php">Favorite</a></TD>
...
for ($k=0;$k<$c;$k++) {
  ...
  if ($n==0) echo '<TR>';
  $link="filmeseriale-hd_ep.php?tip=tv&title=".urlencode(fix_t($title))."&link=".urlencode($link_film)."&image=".$image."&sez=&ep=%ep_tit=";
   if ($tast == "NU")
