...
$has_add="yes";
$has_fs="yes";
$fav_target="lightdl_s_fav.php";
$add_target="lightdl_s_add.php";
$add_file="lightdl_s_add.php";
$fs_target="lightdl_ep.php";
$target="lightdl_s.php";
/* ==================================================== */
...
echo '</TR>';
$link="https://www.lightdl.xyz/search/label/TV%20SERIES";
$ua="Mozilla/5.0 (Windows NT 10.0; rv:63.0) Gecko/20100101 Firefox/63.0";
  ...
  $html = curl_exec($ch);
  curl_close($ch);
$t1=explode('<h2>TV SERIES</h2>',$html);
$html=$t1[1];
