...
! function() {
    ...
    t.enc.Base64 = {
        stringify: function(t) {
            ...
            t.clamp(), t = [];
            for (var n = 0; n < r; n += 3)
                for (var s = (e[n >>> 2] >>> 24 - 8 * (n % 4) & 255) << 16 | (e[n + 1 >>> 2] >>> 24 - 8 * ((n + 1) % 4) & 255) << 8 | e[n + 2 >>> 2] >>> 24 - 8 * ((n + 2) % 4) & 255, o = 0; 4 > o && n + .75 * o < r; o++) t.push(i.charAt(s >>> 6 * (3 - o) & 63));
            if (e = i.charAt(64))
...
function(t) {
    ...
    o = o.MD5 = a.extend({
        ...
        _doProcessBlock: function(t, s) {
            ...
            o[0] = o[0] + m | 0, o[1] = o[1] + z | 0, o[2] = o[2] + w | 0, o[3] = o[3] + C | 0
        },
        _doFinalize: function() {
            ...
            for (r[(n + 64 >>> 9 << 4) + 15] = (s << 8 | s >>> 24) & 16711935 | (s << 24 | s >>> 8) & 4278255360, r[(n + 64 >>> 9 << 4) + 14] = (i << 8 | i >>> 24) & 16711935 | (i << 24 | i >>> 8) & 4278255360, e.sigBytes = 4 * (r.length + 1), this._process(), r = (e = this._hash).words, i = 0; 4 > i; i++) n = r[i], r[i] = (n << 8 | n >>> 24) & 16711935 | (n << 24 | n >>> 8) & 4278255360;
            return e
        },
        clone: function() {
...
//alert (e);
                            ...
                            var r = r.split("\\x"),
                                n = "";
                            for (var s of atob(e.m.split("").reduce((t, e) => e + t, "")).split("|")) n += "\\x" + r[parseInt(s) + 1];
//alert (JSON.stringify(e));
                            return r = n, e = JSON.stringify(e), ("string" == typeof r ? d : p).decrypt(t, e, r, i)
                        }
                    }
                }
            });
        ...
        u.Encryptor = u.extend({
            ...
            pad: function(t, e) {
                for (var r = 4 * e, r = r - t.sigBytes % r, i = r << 24 | r << 16 | r << 8 | r, s = [], o = 0; o < r; o += 4) s.push(i);
        ...
        var _ = r.CipherParams = i.extend({
            ...
            p = r.SerializableCipher = i.extend({
                ...
                encrypt: function(t, e, r, i) {
                    ...
                    return e = n.finalize(e), n = n.cfg, _.create({
                        ciphertext: e,
                        key: r,
                        iv: n.iv,
                        algorithm: t,
            ...
            e = (e.kdf = {}).OpenSSL = {
                execute: function(t, e, r, i) {
                    return i || (i = n.random(8)), t = c.create({
                        keySize: e + r
                    }).compute(t, i), r = n.create(t.words.slice(e), 4 * r), t.sigBytes = 4 * e, _.create({
                        key: t,
                        iv: r,
                        salt: i
                    })
    ...
    function() {
        for (var t = CryptoJS, e = t.lib.BlockCipher, r = t.algo, i = [], n = [], s = [], o = [], c = [], a = [], f = [], h = [], u = [], _ = [], p = [], d = 0; 256 > d; d++) p[d] = 128 > d ? d << 1 : d << 1 ^ 283;
        ...
        var k = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
            r = r.AES = e.extend({
                _doReset: function() {
                    for (var t = this._key, e = t.words, r = t.sigBytes / 4, t = 4 * ((this._nRounds = r + 6) + 1), n = this._keySchedule = [], s = 0; s < t; s++)
                        if (s < r) n[s] = e[s];
                        else {
                            var o = n[s - 1];
                            s % r ? 6 < r && 4 == s % r && (o = i[o >>> 24] << 24 | i[o >>> 16 & 255] << 16 | i[o >>> 8 & 255] << 8 | i[255 & o]) : (o = i[(o = o << 8 | o >>> 24) >>> 24] << 24 | i[o >>> 16 & 255] << 16 | i[o >>> 8 & 255] << 8 | i[255 & o], o ^= k[s / r | 0] << 24), n[s] = n[s - r] ^ o
                        } for (r = 0, e = this._invKeySchedule = []; r < t; r++) s = t - r, o = r % 4 ? n[s] : n[s - 4], e[r] = 4 > r || 4 >= s ? o : f[i[o >>> 24]] ^ h[i[o >>> 16 & 255]] ^ u[i[o >>> 8 & 255]] ^ _[i[255 & o]]
                },
                ...
                decryptBlock: function(t, e) {
                    var r = t[e + 1];
                    t[e + 1] = t[e + 3], t[e + 3] = r, this._doCryptBlock(t, e, this._invKeySchedule, f, h, u, _, n), r = t[e + 1], t[e + 1] = t[e + 3], t[e + 3] = r
                },
                _doCryptBlock: function(t, e, r, i, n, s, o, c) {
                    for (var a = this._nRounds, f = t[e] ^ r[0], h = t[e + 1] ^ r[1], u = t[e + 2] ^ r[2], _ = t[e + 3] ^ r[3], p = 4, d = 1; d < a; d++) var l = i[f >>> 24] ^ n[h >>> 16 & 255] ^ s[u >>> 8 & 255] ^ o[255 & _] ^ r[p++],
                        y = i[h >>> 24] ^ n[u >>> 16 & 255] ^ s[_ >>> 8 & 255] ^ o[255 & f] ^ r[p++],
                        v = i[u >>> 24] ^ n[_ >>> 16 & 255] ^ s[f >>> 8 & 255] ^ o[255 & h] ^ r[p++],
                        _ = i[_ >>> 24] ^ n[f >>> 16 & 255] ^ s[h >>> 8 & 255] ^ o[255 & u] ^ r[p++],
                        f = l,
                        h = y,
                        u = v;
                    l = (c[f >>> 24] << 24 | c[h >>> 16 & 255] << 16 | c[u >>> 8 & 255] << 8 | c[255 & _]) ^ r[p++], y = (c[h >>> 24] << 24 | c[u >>> 16 & 255] << 16 | c[_ >>> 8 & 255] << 8 | c[255 & f]) ^ r[p++], v = (c[u >>> 24] << 24 | c[_ >>> 16 & 255] << 16 | c[f >>> 8 & 255] << 8 | c[255 & h]) ^ r[p++], _ = (c[_ >>> 24] << 24 | c[f >>> 16 & 255] << 16 | c[h >>> 8 & 255] << 8 | c[255 & u]) ^ r[p++], t[e] = l, t[e + 1] = y, t[e + 2] = v, t[e + 3] = _
                },
                keySize: 8
            });
