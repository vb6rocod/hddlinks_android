...
$add_file="";
$fs_target="";
$target="deseneledublate.php";
/* ==================================================== */
if($tip=="release") {
 if ($page>1)
  $l="http://deseneledublate.blogspot.ro/search?updated-max=".urlencode($link)."&max-results=32";
 else
...
if (!isset($_GET["page"]))
  ...
  $page=$_GET["page"];
$next=$base."?page=".($page+1)."&".$p."&link=".$search;
$prev=$base."?page=".($page-1)."&".$p."&link=".$search_prev;
/* ==================================================== */
...
foreach($videos as $video) {
  ...
  if (substr($title, -2) == " -") $title=substr($title, 0, -2);
  $year="";
  $imdb="";
