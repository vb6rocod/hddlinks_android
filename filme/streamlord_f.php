...
$has_add="yes";
$has_fs="yes";
$ref="http://www.streamlord.com";
$host=parse_url($ref)['host'];
$fav_target="streamlord_f_fav.php?host=".$ref;
$add_target="streamlord_f_add.php";
$add_file="";
$fs_target="streamlord_fs.php";
$target="streamlord_f.php";
/* ==================================================== */
...
if($tip=="release") {
  if ($page==1)
   $l="http://www.streamlord.com/movies.html";
  else
   $l="http://www.streamlord.com/movies.php?page=".$page;
} else {
...
if ($tip=="release") {
  ...
  foreach($videos as $video) {
   ...
   $t2=explode('<',$t1[1]);
   $year=trim($t2[0]);
   if (strpos($link,"watch-movie") !== false) $r[]=array($link,$title,$image,$year);
  }
} else {
