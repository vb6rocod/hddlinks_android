...
$has_add="yes";
$has_fs="yes";
$fav_target="xemovies_f_fav.php?host=".$last_good;
$add_target="xemovies_f_add.php";
$add_file="";
$fs_target="xemovies_fs.php";
$target="xemovies_f.php";
/* ==================================================== */
...
// https://xemovies.to/search?query=star&_token=MeiH6WHafp5WcEhgoiMbICIUYvoNCrZcMGQPSmMy&q=star&page=2
