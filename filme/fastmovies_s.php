...
$fav_target="fastmovies_s_fav.php?host=".$last_good;
$add_target="fastmovies_s_add.php";
$add_file="";
$fs_target="fastmovies_ep.php";
$target="fastmovies_s.php";
/* ==================================================== */
...
if ($tip=="search") {
 ...
 if ($page==1)
  $l=$last_good."/tv-shows-fastmovies.html";
 else
  $l=$last_good."/tv-shows-fastmovies.html?p=".$page;
}
