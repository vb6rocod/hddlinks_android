...
$fav_target="hdmoviebox_s_fav.php?host=".$last_good;
$add_target="hdmoviebox_s_add.php";
$add_file="";
$fs_target="hdmoviebox_ep.php";
$target="hdmoviebox_s.php";
/* ==================================================== */
