...
$l= "http://topfilmenoi.net/?s=".$search;
//echo $html;
}
?>
<html><head>
...
if ($page > 1)
echo '<a class="nav" href="topfilmenoi.php?page='.($page-1).'&link='.$search.'&title='.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a class="nav" href="topfilmenoi.php?page='.($page+1).'&link='.$search.'&title='.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a class="nav" href="topfilmenoi.php?page='.($page+1).'&link='.$search.'&title='.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
}
  $ch = curl_init();
