...
if ($page > 1)
echo '<a class="nav" href="'.$prev.'"><font size="4">&nbsp;&lt;&lt;&nbsp;</font></a> | <a class="nav" href="'.$next.'"><font size="4">&nbsp;&gt;&gt;&nbsp;</font></a></TD></TR>';
else
...
for ($k=0;$k<$c;$k++) {
  ...
  if ($n==0) echo '<TR>';
  if ($tast == "NU")
    echo '<td class="mp" align="center" width="25%"><a class="imdb" href="'.$link_f.'" target="blank"><img src="'.$image.'" width="'.$width.'" height="'.$height.'"><BR><font size="4">'.$title.'</font></a></TD>';
  else {
  echo '<td class="mp" align="center" width="25%"><a class ="imdb" id="myLink'.($w*1).'" href="'.$link_f.'" target="blank"><input type="hidden" id="imdb_myLink'.($w*1).'" value="'.$val_imdb.'"><img src="'.$image.'" width="'.$width.'" height="'.$height.'"><BR><font size="4">'.$title.'</font></a></TD>';
  $w++;
  }
  $n++;
  if ($n == 4) {
