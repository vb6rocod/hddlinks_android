...
$has_add="yes";
$has_fs="yes";
$fav_target="vipmovies_s_fav.php?host=https://vipmovies.to";
$add_target="vipmovies_s_add.php";
$add_file="";
$fs_target="vipmovies_s_ep.php";
$target="vipmovies_s.php";
/* ==================================================== */
...
if ($tip=="release") {
  $l="https://vipmovies.to/api/list/content?type=tvseries&count=40&page=".$page;
  $ch = curl_init();
  ...
  for($k=0;$k<count($x);$k++) {
    ...
    $tip=$x[$k]['type'];
    if ($tip=="1") array_push($r ,array($title,$link, $image));
  }
$c=count($r);
for ($k=0;$k<$c;$k++) {
  $title=$r[$k][0];
