...
function ajaxrequest(link) {
  ...
  var the_data = link;
  //alert(the_data);
  var php_file="chillax_f_add.php";
...
echo '<a class="nav" href="chillax_f.php?page='.($page-1).'&gen='.$gen.'&token='.$token.'&tip='.$tip.'&title='.$title.'">&nbsp;&lt;&lt;&nbsp;</a> | <a class="nav" href="chillax_f.php?page='.($page+1).'&gen='.$gen.'&token='.$token.'&tip='.$tip.'&title='.$title.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
}else {
echo '<TD colspan="4" align="right"><a href="chillax_f.php?page='.($page+1).'&gen='.$gen.'&token='.$token.'&tip='.$tip.'&title='.$title.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
}
}

if ($tip=="search") {
//$l="https://cineplex.to/search/auto?q=".str_replace("+","%20",urlencode($title))."&_=";
$l="https://chillax.ws/index/loadmovies";
...
$head=array('Accept-Language: ro-ro,ro;q=0.8,en-us;q=0.6,en-gb;q=0.4,en;q=0.2','Accept-Encoding: deflate','Content-Type: application/x-www-form-urlencoded','X-Requested-With: XMLHttpRequest','Content-Length: '.strlen($post));
  ...
  $l="https://chillax.ws/index/loadmoviesnew";
...
if ($tip=="search") {
  ...
  foreach($videos as $video) {
    ...
    $t2=explode('"',$t1[1]);
    $imdb="https://chillax.ws".$t2[0];
    $link_fs='chillax_fs.php?tip=movie&imdb='.$imdb.'&title='.urlencode(fix_t($title1)).'&image='.$image."&year=".$year."&token=".$token;
...
echo '<a class="nav" href="chillax_f.php?page='.($page+1).'&gen='.$gen.'&token='.$token.'&tip='.$tip.'&title='.$title.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
}
echo "</table>";
?>
<br></div></body>
