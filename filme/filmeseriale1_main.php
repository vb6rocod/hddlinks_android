...
echo '<a class="nav" href="filmeseriale1_main.php?page='.($page-1).'&file='.$file.'&title='.urlencode($title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a class="nav" href="filmeseriale1_main.php?page='.($page+1).'&file='.$file.'&title='.urlencode($title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
}else {
echo '<TR><TD class="cat" ><a id="fav" href="filmeseriale_fav.php" target="blank">Favorite</a></TD>
<TD class="form" colspan="2">';
//title=star&page=1&file=search
echo '<form action="filmeseriale1_main.php" target="_blank">Cautare serial:';
...
echo '<TD colspan="1" align="right"><a class="nav" href="filmeseriale1_main.php?page='.($page+1).'&file='.$file.'&title='.urlencode($title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
}
}
///////////////////////////////////////////////////////////
//$l =$search."/page/".$page."/";
...
echo '<a class="nav" href="filmeseriale1_main.php?page='.($page+1).'&file='.$file.'&title='.urlencode($title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
}
echo "</table>";
?>
</div>
