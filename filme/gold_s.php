...
$has_add="yes";
$has_fs="yes";
$fav_target="gold_s_fav.php?host=https://filmeonlinegratis.org";
$add_target="gold_s_add.php";
$add_file="";
$fs_target="gold_s_ep.php";
$target="gold_s.php";
/* ==================================================== */
...
if ($tip=="release") {
if($page>1) {
  $l ="https://filmeonlinegratis.org/seriale"."/page/".$page."/";
} else {
	$page = 1;
  $l="https://filmeonlinegratis.org/seriale/";
}
} else {
