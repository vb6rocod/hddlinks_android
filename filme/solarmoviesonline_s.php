...
$has_add="yes";
$has_fs="yes";
$fav_target="solarmoviesonline_s_fav.php?host=http://solarmoviesonline.net";
$add_target="solarmoviesonline_s_add.php";
$add_file="";
$fs_target="solarmoviesonline_ep.php";
$target="solarmoviesonline_s.php";
/* ==================================================== */
...
if($tip=="release") {
  $l="http://solarmoviesonline.net/list/tv-series.html?p=".$page;
} else {
...
foreach($videos as $video) {
  ...
  $imdb="";
  $sez="";
  if (preg_match("/(:|-)?\s+S(\d+)/i",$title,$m)) {         //Bless This Mess - S02
