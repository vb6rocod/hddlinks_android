...
$has_add="yes";
$has_fs="yes";
$fav_target="pubfilm_f_fav.php?host=https://".$host;
$add_target="pubfilm_f_add.php";
$add_file="";
$fs_target="pubfilm_fs.php";
$target="pubfilm_f.php";
/* ==================================================== */
...
if($tip=="release") {
  if ($page > 1)
  $l="https://".$host."/trending/page/".$page."/?get=movies";
  else
  $l="https://".$host."/trending/?get=movies";
} else {
