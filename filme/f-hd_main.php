...
f-hd</th></TR>';
echo '<TR><TD class="cat">'.'<a href="f-hd.php?page=1&tip=release&link=https://f-hd.biz/&title=Recente" target="_blank">Recente</a></TD>
<TD class="form" colspan="2"><form action="f-hd.php" target="_blank">
...
foreach($videos as $video) {
    ...
    $t3 = explode('<', $t2[1]);
    $title = $t3[0];
    $link="f-hd.php?page=1&tip=release&link=".$link."&title=".urlencode($title);
