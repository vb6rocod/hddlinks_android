...
$has_add="yes";
$has_fs="yes";
$fav_target="serialeonline_biz_fav.php?host=https://serialeonline.biz";
$add_target="serialeonline_biz_add.php";
$add_file="";
$fs_target="serialeonline_biz_ep.php";
$target="serialeonline_biz.php";
/* ==================================================== */
...
if ($tip == "release")
   if ($page > 1)
    $l="https://serialeonline.biz/series/page/".$page."/";
   else
    $l="https://serialeonline.biz/series/";
else {
  $search=str_replace(" ","+",$tit);
  if ($page == 1)
    $l="https://serialeonline.biz/?s=".$search;
  else
    $l="https://serialeonline.biz/page/".$page."/?s=".$search;
}
$r=array();
...
for ($k=0;$k<$c;$k++) {
  ...
  if ($title && strpos($link,"/series") !== false) {
  if ($n==0) echo '<TR>'."\r\n";
