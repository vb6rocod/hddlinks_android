...
echo '<TR><TD style="background-color:#0a6996;color:#64c8ff;font-weight: bold;font-size: 1.5em" align="center" colspan="5">Alegeti o subtitrare (cauta titlu)</td></TR>';
echo '<TR>';
...
echo '</TR></TABLE>';
echo '<table border="1" width="100%">';
echo '<TR><TD style="background-color:#0a6996;color:#64c8ff;font-weight: bold;font-size: 1.5em" align="center" colspan="5">Alegeti o subtitrare (cauta imdb id)</td></TR>';
echo '<TR>';
