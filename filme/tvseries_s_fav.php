...
$file=$base_fav."tvseries_s_new.dat";
$arr=array();
$h="";
if (file_exists($file)) {
...
foreach($arr as $key => $value) {
    ...
    $title11 = $key;
    $image=$arr[$key]["image"];
    $link='tvseries_sez.php?tip=series&tip=series&file='.$link1.'&title='.urlencode(fix_t($title11)).'&image='.urlencode($image)."&sez=&ep=&ep_tit=";
  if ($n==0) echo '<TR>';
