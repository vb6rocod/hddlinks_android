...
if($tip=="release") {
 if ($page>1)
  $l ="https://filme-bune.info/page/".$page."/";
 else
  $l="https://filme-bune.info/";
} else {
  $search=str_replace(" ","+",$tit);
  if ($page > 1)
     $l="https://filme-bune.info/search/".$search."/page/".$page."/";
  else
     $l="https://filme-bune.info/search/".$search."/";
}
...
$videos = explode('h2 class="titlu"', $html);
