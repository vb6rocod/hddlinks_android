...
function ajaxrequest(link) {
  ...
  var the_data = link;
  //alert(the_data);
  var php_file="hdpopcorns_add.php";
...
echo '<a class="nav" href="hdpopcorns.php?page='.($page-1).'&file='.$file.'&title='.urlencode($title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a class="nav" href="hdpopcorns.php?page='.($page+1).'&file='.$file.'&title='.urlencode($title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
}else {
echo '<TR><TD class="cat"><a class "imdb" id="fav" href="hdpopcorns_fav.php" target="blank">Favorite</a></TD>
<TD class="form" colspan="2">';
//echo '<TD colspan="2">';
//title=star&page=1&file=search
echo '<form action="hdpopcorns.php" target="_blank">Cautare film:';
...
echo '<TD colspan="1" align="right"><a class="nav" href="hdpopcorns.php?page='.($page+1).'&file='.$file.'&title='.urlencode($title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
}
}
$ua = $_SERVER['HTTP_USER_AGENT'];
$cookie=$base_cookie."hdpopcorns.dat";
$requestLink="http://hdpopcorns.co/";
...
if ($tip=="search")
  $requestLink = "http://hdpopcorns.co/page/".$page."/?s=".str_replace(" ","+",$title);
 else
$requestLink="http://hdpopcorns.co/category/latest-movies/page/".$page."/";
//echo $requestLink;
...
//echo $l;
//echo $html;
 $videos = explode('article class="latestPost', $html);
unset($videos[0]);
...
foreach($videos as $video) {
  ...
  $link2='hdpopcorns_fs.php?tip=movie&link='.$link1.'&title='.urlencode(fix_t($title11))."&image=&sez=&ep=&ep_tit=";
...
echo '<a class="nav" href="hdpopcorns.php?page='.($page+1).'&file='.$file.'&title='.urlencode($title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
}
echo "</table>";
?>
<br></div></body>
