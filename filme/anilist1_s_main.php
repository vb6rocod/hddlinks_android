...
$has_add="yes";
$has_fs="yes";
$fav_target="anilist1_s_fav.php";
$add_target="anilist1_s_add.php";
$add_file="anilist1_s_add.php";
$fs_target="anilist1_s.php";
$target="anilist1_s_main.php";
/* ==================================================== */
...
echo '</TR>';
$link="https://anilist1.ir/?dir=Series";
...
$videos = explode('href="?dir=Series/', $html);
unset($videos[0]);
$videos = array_values($videos);

foreach($videos as $video) {
    $t1 = explode('"', $video);
    $link = "https://anilist1.ir/?dir=Series/".$t1[0];
