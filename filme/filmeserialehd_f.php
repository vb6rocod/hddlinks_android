...
if($tip=="release") {
  $l="https://filmeserialehd.ro/category/film/page/".$page."/";
} else {
  $search=str_replace(" ","+",$tit);
  if ($page > 1)
     $l="https://filmeserialehd.ro/page/".$page."/?s=".$search;
  else
     $l="https://filmeserialehd.ro/?s=".$search;
}
$r=array();
