...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 $search3 = "https://www.pornhd.com/search?search=".$search1."&page=".$page1;
}
?>
<html><head>
...
if ($page1) {
if ($page1 > 1)
echo '<a href="pornhd.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="pornhd.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="pornhd.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
  $ch = curl_init();
...
if ($page > 1)
echo '<a href="pornhd.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="pornhd.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="pornhd.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
...
foreach($videos as $video) {
    ...
    $t2 = explode('"', $t1[1]);
    $link = "https://www.pornhd.com".$t2[0];

    $title=str_between($video,'alt="','"');
    if (strpos($video,'data-original="') !== false) {
    $t1 = explode('data-original="', $video);
    $t2 = explode('"', $t1[1]);
    $image = $t2[0];
    //$image=str_replace("thumbnail.","thumbnail1.",$image);
    } else {
  ...
  if ($n==0) echo '<TR>';
  if ($flash != "mp") {
  $link = "pornhd_link.php?file=".$link."&title=".urlencode($title);
