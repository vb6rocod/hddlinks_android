...
echo '<TR><td style="color:black;background-color:#0a6996;color:#64c8ff;text-align:center" colspan="3"><font size="6"><b>incestvidz</b></TD></TR>';
echo '<TR><TD class="cat" colspan="1">'.'<a href="incestvidz.php?page=1,https://www.incestvidz.com/,Recente" target="_blank"><b>Recente</b></a></TD>';
echo '<TD class="form" colspan="2"><form action="incestvidz.php" target="_blank">Cautare <input type="hidden" name="page1" id="page1" value="1"><input type="text" id="src" name="src" value="'.$val_search.'"><input type="submit" value="Cauta" id="send"></form></td>';
...
foreach($videos as $video) {
    ...
    $link="incestvidz.php?page=1,".$link.",".urlencode($title);
