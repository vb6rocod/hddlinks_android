...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 $search="http://milfzr.com/page/".$page1."?s=".$search1;
//http://www.pornhub.com/video?search=mature+mom
//http://www.pornhub.com/video/search?search=mother&page=2
//http://milfzr.com/page/2?s=mom+son
}
?>
<html><head>
...
if ($page1) {
if ($page1 > 1)
echo '<a href="milfzr.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href=<a href="milfzr.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="milfzr.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
} else {
if ($page > 1)
echo '<a href="milfzr.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="milfzr.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="milfzr.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
}
//http://milfzr.com/page/2?s=mom+son
if (!$page1) {
if($page>1) {
...
foreach($videos as $video) {
    ...
    //if (strpos($image,"milfzr.com") !== false) $image="r.php?file=".$image;
  ...
  if ($n==0) echo '<TR>';
  if ($flash != "mp") {
  $link = "milfzr_link.php?file=".$link."&title=".$title;
