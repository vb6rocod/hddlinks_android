...
if($tip=="release") {
  if ($page>1)
    $l = "https://www.pornhub.com/video?".$link."&page=".$page;
  else
    $l = "https://www.pornhub.com/video?".$link;
} else {
  $search=str_replace(" ","+",$tit);
  if ($page > 1)
    $l="https://www.pornhub.com/video/search?search=".$search."&page=".$page;
  else
    $l="https://www.pornhub.com/video/search?search=".$search."&page=".$page;
}
