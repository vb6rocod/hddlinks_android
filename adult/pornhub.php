...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 $search="https://www.pornhub.com/video/search?search=".$search1."&page=".$page1;
...
if ($page1) {
if ($page1 > 1)
echo '<a href="pornhub.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="pornhub.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="pornhub.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
} else {
if ($page > 1)
echo '<a href="pornhub.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="pornhub.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="pornhub.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
}
if (!$page1) {
if($page>1) {
    if($search) {
        $l = "https://www.pornhub.com/video?".$search."&page=".$page;
    } else {
        $l = "https://www.pornhub.com/video?".$search."&page=".$page;
    }
} else {
    if($search) {
        $l = "https://www.pornhub.com/video?".$search;
    } else {
        $l = "https://www.pornhub.com/video?".$search;
    }
}
