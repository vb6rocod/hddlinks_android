...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 $search3 = "https://www.eporner.com/search/".$search1."/".$page1."/";
}
?>
<html><head>
...
if ($page1) {
if ($page1 > 1)
echo '<a href="eporner.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="eporner.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="eporner.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
//echo $search3;
...
if ($page > 1)
echo '<a href="eporner.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="eporner.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="eporner.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
...
foreach($videos as $video) {
  ...
  if ($n==0) echo '<TR>';
  if ($flash != "mp") {
  $link = "eporner_link.php?file=".$link."&title=".urlencode($title);
