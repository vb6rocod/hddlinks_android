...
if($tip=="release") {
  if ($page==1)
  $l="https://www.gotporn.com/?src=mn:mr";
  else
  $l="https://www.gotporn.com/?page=".$page."&src=mn:mr";
} else {
  $search=str_replace(" ","%20",$tit);
  $l="https://www.gotporn.com/results?search_query=".$search."&page=".$page;
}
$host=parse_url($l)['host'];
  ...
  curl_setopt($ch, CURLOPT_REFERER,"https://www.gotporn.com");
...
//echo $html;
$r=array();
$videos = explode('<li class="video-item',$html);
unset($videos[0]);
