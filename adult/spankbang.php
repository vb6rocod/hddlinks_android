...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 //$search="https://www.redtube.com/?search=".$search1."&page=".$page1;
  if ($page1 > 1)
  $search="https://pl.spankbang.com/s/".$search1."/".$page1."/";
  else
  $search="https://pl.spankbang.com/s/".$search1;
...
if ($page1) {
if ($page1 > 1)
echo '<a href="spankbang.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="spankbang.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="spankbang.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
...
if ($page > 1)
echo '<a href="spankbang.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="spankbang.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="spankbang.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
