...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 //https://www.pornrabbit.com/search/mom%20son/2/
 $search3 = "https://www.pornrabbit.com/search/".str_replace("+","%20",$search1)."/".$page1."/";
}
?>
<html><head>
...
function ajaxrequest(title, link) {
  ...
  var php_file="pornrabbit_link.php";
...
if ($page1) {
if ($page1 > 1)
echo '<a href="pornrabbit.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="pornrabbit.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="pornrabbit.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
//echo $search3;
...
//https://www.youjizz.com/search/mature-mom-anal-1.html?
  ...
  curl_setopt($ch, CURLOPT_REFERER, "https://www.pornrabbit.com/");
...
if ($page > 1)
echo '<a href="pornrabbit.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="pornrabbit.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="pornrabbit.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
...
foreach($videos as $video) {
  ...
  if ($n==0) echo '<TR>';
  if ($flash != "mp") {
  $link = "pornrabbit_link.php?file=".$link."&title=".urlencode($title);
