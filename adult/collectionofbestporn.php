...
$target="collectionofbestporn.php";
/* ==================================================== */
...
if($tip=="release") {
  if ($page==1)
  $l="https://collectionofbestporn.com/";
  else
  $l="https://collectionofbestporn.com/most-recent/page/".$page;
} else {
  $search=str_replace(" ","-",$tit);
  if ($page==1)
  $l="https://collectionofbestporn.com/search/".$search;
  else
  $l="https://collectionofbestporn.com/search/".$search."/page/".$page;
}
