...
if ($page1) {
if ($page1 > 1)
echo '<a href="incestvidz.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="incestvidz.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="incestvidz.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
//$post = "s=".$search;
//https://www.incestvidz.com/page/2/?s=mom
if ($page1>1)
  $search3="https://www.incestvidz.com/page/".$page1."/?s=".$search;
else
  $search3="https://www.incestvidz.com/?s=".$search;
...
if ($page > 1)
echo '<a href="incestvidz.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="incestvidz.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="incestvidz.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
...
foreach($videos as $video) {
    ...
    $link = "../filme/filme_link.php?file=".urlencode($link).",".urlencode($title);
  if ($title) {
  if ($n==0) echo '<TR>';
