...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 $search3 = "https://www.4tube.com/search?q=".$search1."&p=".$page1;
}
?>
<html><head>
...
function ajaxrequest(title, link) {
  ...
  on();
  var the_data = "mod=title="+ title +"&link="+link;
...
if ($page1) {
if ($page1 > 1)
echo '<a href="4tube.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="4tube.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="4tube.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
  $ch = curl_init();
...
if ($page > 1)
echo '<a href="4tube.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="4tube.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="4tube.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
...
foreach($videos as $video) {
    ...
    $t2 = explode('"', $video);
    //$link = $t2[0];
    $link="https://www.4tube.com/videos/".$t2[0]."/ceva";
