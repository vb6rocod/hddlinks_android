...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 //https://www.drtuber.com/search/videos/mom%20son/2
 $search3 = "https://www.drtuber.com/search/videos/".$search1."/".$page1;
}
?>
<html><head>
...
if ($page1) {
if ($page1 > 1)
echo '<a href="drtuber.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="drtuber.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="drtuber.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
//echo $search3;
...
//https://www.youjizz.com/search/mature-mom-anal-1.html?
  ...
  curl_setopt($ch, CURLOPT_REFERER, "https://www.drtuber.com");
...
if ($page > 1)
echo '<a href="drtuber.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="drtuber.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="drtuber.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
...
foreach($videos as $video) {
    ...
    $t1=explode('class="time_thumb">',$video);
    $t2=explode('em>',$t1[1]);
    $t3=explode("<",$t2[1]);
    $data=" (".$t3[0].")";
  if ($n==0) echo '<TR>';
  if ($flash != "mp") {
  $link = "drtuber_link.php?file=".$link."&title=".urlencode($title);
