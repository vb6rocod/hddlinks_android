...
if($tip=="release") {
  if ($page>1)
    $l = "http://www.pornheed.com/search/recently-added/all-time/all-tubes/all-words/all-duration/".$link."/".$page;
  else
    $l = "http://www.pornheed.com/search/recently-added/all-time/all-tubes/all-words/all-duration/".$link."/".$page;
} else {
  $search=str_replace(" ","+",$tit);
  if ($page > 1)
    $l="http://www.pornheed.com/search/recently-added/all-time/all-tubes/all-words/all-duration/".$search."/".$page;
  else
    $l="http://www.pornheed.com/search/recently-added/all-time/all-tubes/all-words/all-duration/".$search."/".$page;
}
...
foreach($videos as $video) {
  ...
  if ($title && $id) array_push($r ,array($title,$link, $image));
}
$c=count($r);
for ($k=0;$k<$c;$k++) {
  $title=$r[$k][0];
