...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 //https://www.porndroids.com/search/?page=2&q=mom%20son
 $search3 = "https://www.porndroids.com/search/?page=".$page1."&q=".$search1;
}
?>
<html><head>
...
function ajaxrequest(title, link) {
  ...
  var php_file="porndroids_link.php";
...
if ($page1) {
if ($page1 > 1)
echo '<a href="porndroids.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="porndroids.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="porndroids.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
//echo $search3;
...
if ($page > 1)
echo '<a href="porndroids.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="porndroids.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="porndroids.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
...
foreach($videos as $video) {
  ...
  if ($n==0) echo '<TR>';
  if ($flash != "mp") {
  $link = "porndroids_link.php?file=".$link."&title=".urlencode($title);
