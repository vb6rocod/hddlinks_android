...
if($query) {
 ...
 $search2="https://www.xnxx.com/?k=".$search3."&p=".$page1;
...
if (!$page1) {
if ($page > 1)
echo '<a href="xnxx.php?page='.($page-1).','.$search.','.urlencode($page_title).'"><font size="4">&nbsp;&lt;&lt;&nbsp;</a> | <a href="xnxx.php?page='.($page+1).','.$search.','.urlencode($page_title).'"><font size="4">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="xnxx.php?page='.($page+1).','.$search.','.urlencode($page_title).'"><font size="4">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
} else {
if ($page1 > 1)
echo '<a href="xnxx.php?page1='.($page1-1).'&src='.$search1.'"><font size="4">&nbsp;&lt;&lt;&nbsp;</a> | <a href="xnxx.php?page1='.($page1+1).'&src='.$search1.'"><font size="4">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="xnxx.php?page1='.($page1+1).'&src='.$search1.'"><font size="4">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
}
if (!$page1) {
...
foreach($videos as $video) {
    ...
    $x1=trim(str_between($video,'</span></span>','<'));
    $x2=explode("-",$x1);
    $x3=trim($x2[0]);
  ...
  if ($n==0) echo '<TR>';
  if ($flash != "mp") {
  $link = "xnxx_link.php?file=".$link."&title=".urlencode($title);
...
if (!$page1) {
if ($page > 1)
echo '<a href="xnxx.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="xnxx.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="xnxx.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
} else {
if ($page1 > 1)
echo '<a href="xnxx.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="xnxx.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="xnxx.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
}
echo "</table>";
?>
<br></div>
