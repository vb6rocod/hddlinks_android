...
echo '<TR><td style="color:black;background-color:#0a6996;color:#64c8ff;text-align:center" colspan="3"><font size="6"><b>pornrabbit</b></TD></TR>';
echo '<TR><TD class="cat" colspan="1">'.'<a href="pornrabbit.php?page=1,https://www.pornrabbit.com/videos/,Recente" target="_blank"><b>Recente</b></a></TD>';
echo '<TD class="form" colspan="2"><form action="pornrabbit.php" target="_blank">Cautare <input type="hidden" name="page1" id="page1" value="1"><input type="text" id="src" name="src" value="'.$val_search.'"><input type="submit" value="Cauta" id="send"></form></td>';
...
foreach($videos as $video) {
    ...
    $t3=explode('<',$t2[1]);
  	$title=$t3[0];
    $link="pornrabbit.php?page=1,".$link.",".urlencode($title);
