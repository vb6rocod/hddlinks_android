...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 //https://www.pornjam.com/search/?q=mom
 //$search="https://www.pornjam.com/ajax/new_search/?page=".$page1."&q=".$search1;
 //$search="https://www.pornjam.com/search/page".$page1.".html?q=".$search1;
 if ($page1==1)
 $search="https://www.pornjam.com/search/?q=".$search1;
 else
 $search="https://www.pornjam.com/ajax/new_search/?page=".$page1."&q=".$search1;
}
?>
...
if ($page1) {
if ($page1 > 1)
echo '<a href="pornjam.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="pornjam.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="pornjam.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
$l = $search;
  $ch = curl_init();
  ...
  curl_setopt($ch, CURLOPT_REFERER, "http://www.pornjam.com");
...
if ($page > 1)
echo '<a href="pornjam.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="pornjam.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="pornjam.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';

if ($page > 1) {
if (strpos($search,"categorie") === false)
  $l="https://www.pornjam.com/ajax/homepage/?page=".$page;
else {
  $t1=explode("/categorie",$search);
  $l="https://www.pornjam.com/ajax/show_category/".$t1[1]."?page=".$page;
}
} else {
 $l=$search;
}
...
foreach($videos as $video) {
  ...
  if ($n==0) echo '<TR>';
  if ($flash != "mp") {
  $link = "pornjam_link.php?file=".$link."&title=".urlencode($title);
