...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 $search2="https://www.tnaflix.com/search.php?what=".$search3."&sb=&su=&sd=&dir=&f=&p=&category=&page=".$page1;
...
if (!$page1) {
if ($page > 1)
echo '<a href="tnaflix.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="tnaflix.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="tnaflix.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
} else {
if ($page1 > 1)
echo '<a href="tnaflix.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="tnaflix.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="tnaflix.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
}
if (!$page1) {
  $link=$search."/".$page;
} else {
...
foreach($videos as $video) {
    ...
    $t2 = explode("'", $t1[1]);
    $link = "https://www.tnaflix.com".$t2[0];
    ...
    $t2 = explode("'", $t1[1]);
    $image = $t2[0];
    $t1=explode("class='videoDuration'>",$video);
    $t2=explode("<",$t1[1]);
    $dur=" (".$t2[0].")";
