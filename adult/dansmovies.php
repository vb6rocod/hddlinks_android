...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 //http://www.dansmovies.com/search/videos/mom-son/page2.html
 $search3 = "http://www.dansmovies.com/search/videos/".str_replace("+","-",$search1)."/page".$page1.".html";
}
?>
<html><head>
...
function ajaxrequest(title, link) {
  ...
  var php_file="dansmovies_link.php";
...
if ($page1) {
if ($page1 > 1)
echo '<a href="dansmovies.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="dansmovies.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="dansmovies.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
//echo $search3;
...
//https://www.youjizz.com/search/mature-mom-anal-1.html?
  ...
  curl_setopt($ch, CURLOPT_REFERER, "http://www.dansmovies.com");
...
if ($page > 1)
echo '<a href="dansmovies.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="dansmovies.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="dansmovies.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
...
$videos = explode('div class="tw"',$html);
...
foreach($videos as $video) {
  ...
  if ($n==0) echo '<TR>';
  if ($flash != "mp") {
  $link = "dansmovies_link.php?file=".$link."&title=".urlencode($title);
