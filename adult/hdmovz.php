...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 //https://www.hdmovz.com/search/2/?q=mom+son
 $search3 = "https://www.hdmovz.com/search/".$page1."/?q=".$search1;
}
?>
<html><head>
...
if ($page1) {
if ($page1 > 1)
echo '<a href="hdmovz.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="hdmovz.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="hdmovz.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
//echo $search3;
...
//https://www.youjizz.com/search/mature-mom-anal-1.html?
  ...
  curl_setopt($ch, CURLOPT_REFERER, "https://www.hdmovz.com/");
...
if ($page > 1)
echo '<a href="hdmovz.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="hdmovz.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="hdmovz.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
//$html = file_get_contents($search."?page=".$page);
//https://www.porn.com/videos?p=2
if (strpos($search,"latest-update") !== false)
   $search3  = $search.$page."/";
else
...
foreach($videos as $video) {
    ...
    $t2 = explode('"', $t1[1]);
    $link = "https://www.hdmovz.com".$t2[0];
  ...
  if ($n==0) echo '<TR>';
  if ($flash != "mp") {
  $link = "hdmovz_link.php?file=".$link."&title=".urlencode($title);
