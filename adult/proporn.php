...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 //https://www.proporn.com/search/videos/mom%20son/2
 $search3 = "https://www.proporn.com/search/videos/".$search1."/".$page1;
}
?>
<html><head>
...
if ($page1) {
if ($page1 > 1)
echo '<a href="proporn.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="proporn.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="proporn.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
//echo $search3;
...
if ($page > 1)
echo '<a href="proporn.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="proporn.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="proporn.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
...
$videos = explode('class="thumb-view">',$html);
