...
if($tip=="release") {
  $l="https://www.bitporno.com/?q=&or=&cat=&sort=recent&time=someday&length=all&view=0&page=".($page-1)."&user=";
} else {
  $search=str_replace(" ","+",$tit);
  $l="https://www.bitporno.com/?q=".$search."&or=&cat=&sort=recent&time=someday&length=all&view=0&page=".($page-1)."&user=";
}
