...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 //http://h2porn.com/search/2/?q=mom+son
 //http://h2porn.com/search/2/?q=mom+son
 $search3 = "http://h2porn.com/search/".$page1."/?q=".$search1;
 //echo $search3;
}
?>
<html><head>
...
if ($page1) {
if ($page1 > 1)
echo '<a href="h2porn.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="h2porn.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="h2porn.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
//echo $search3;
...
if ($page > 1)
echo '<a href="h2porn.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="h2porn.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="h2porn.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
...
foreach($videos as $video) {
  ...
  if ($n==0) echo '<TR>';
  if ($flash != "mp") {
  $link = "h2porn_link.php?file=".$link."&title=".urlencode($title);
