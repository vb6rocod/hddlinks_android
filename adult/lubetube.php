...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 //https://lubetube.com/search/adddate/title/mom/?page=2
 $search3 = "https://lubetube.com/search/adddate/title/".$search1."/&page=".$page1;
}
?>
<html><head>
...
function ajaxrequest(title, link) {
  ...
  var php_file="lubetube_link.php";
...
if ($page1) {
if ($page1 > 1)
echo '<a href="lubetube.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="lubetube.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="lubetube.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
  $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, $search3);
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
  curl_setopt($ch, CURLOPT_USERAGENT, 'Mozilla/5.0 (Windows; U; Windows NT 6.1; en-US; rv:1.9.1.2) Gecko/20090729 Firefox/3.5.2 GTB5');
  curl_setopt($ch, CURLOPT_FOLLOWLOCATION  ,1);
  curl_setopt($ch, CURLOPT_REFERER, "https://lubetube.com/");
...
if ($page > 1)
echo '<a href="lubetube.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="lubetube.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="lubetube.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
...
$videos = explode('a class="frame', $html);
...
foreach($videos as $video) {
    ...
    $t1=explode('Length:',$video);
    //$t2=explode('>',$t1[1]);
    $t3=explode("<",$t1[1]);
    $data=" (".$t3[0].")";
  if ($n==0) echo '<TR>';
  if ($flash != "mp") {
  $link = "lubetube_link.php?file=".$link."&title=".urlencode($title);
