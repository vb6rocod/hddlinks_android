...
if($tip=="release") {
  ...
  if ($page > 1)
    $l="https://www.thumbzilla.com/video/search?q=".$search;
  else
    $l="https://www.thumbzilla.com/video/search?q=".$search."&page=".$page;
}
