...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 //echo $search2;
 $page_title="Cautare: ".str_replace("-"," ",$search2);
 //$search="http://www.redtube.com/?search=".$search1."&page=".$page1;
 //http://pornmaki.com/search/videos/mom-son/page2.html
 $search3 = "http://pornmaki.com/search/videos/".$search2."/page".$page1.".html";
}
?>
<html><head>
...
function ajaxrequest(title, link) {
  ...
  var php_file="pornmaki_link.php";
...
if ($page1) {
if ($page1 > 1)
echo '<a href="pornmaki.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="pornmaki.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="pornmaki.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
//echo $search3;
...
if ($page > 1)
echo '<a href="pornmaki.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="pornmaki.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="pornmaki.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
...
foreach($videos as $video) {
  ...
  if ($n==0) echo '<TR>';
  if ($flash != "mp") {
  $link = "pornmaki_link.php?file=".$link."&title=".urlencode($title);
