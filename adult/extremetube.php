...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 $search3 = "https://www.extremetube.com/videos?search=".$search1."&format=json&number_pages=1&page=".$page1;
}
?>
<html><head>
...
function ajaxrequest(title, link) {
  ...
  var php_file="extremetube_link.php";
...
if ($page1) {
if ($page1 > 1)
echo '<a href="extremetube.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="extremetube.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="extremetube.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
//echo $search3;
...
if ($page > 1)
echo '<a href="extremetube.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="extremetube.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="extremetube.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
//$html = file_get_contents($search."?page=".$page);
//https://www.porn.com/videos?p=2
if ($search=="videos")
  $search3="https://www.extremetube.com/videos?format=json&number_pages=1&page=".$page;
else
  $search3="https://www.extremetube.com".str_replace("*","?",$search)."&format=json&number_pages=1&page=".$page;
...
for ($k=0;$k<count($r);$k++) {
  ...
  if ($n==0) echo '<TR>';
  if ($flash != "mp") {
  $link = "extremetube_link.php?file=".$link."&title=".urlencode($title);
