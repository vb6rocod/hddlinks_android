...
if($tip=="release") {
if ($link=="videos")
  $l="https://www.extremetube.com/videos?format=json&number_pages=1&page=".$page;
else
  $l="https://www.extremetube.com".str_replace("*","?",$link)."&format=json&number_pages=1&page=".$page;
} else {
  $search=str_replace(" ","+",$tit);
  if ($page > 1)
    $l="https://www.extremetube.com/videos?search=".$search."&format=json&number_pages=1&page=".$page;
  else
    $l="https://www.extremetube.com/videos?search=".$search."&format=json&number_pages=1&page=".$page;
}
