...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 //https://www.eroxia.com/search/mom-son/page2.html
 $search3 = "https://www.eroxia.com/search/".str_replace("+","-",$search1)."/page".$page1.".html";
}
?>
<html><head>
...
if ($page1) {
if ($page1 > 1)
echo '<a href="eroxia.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="eroxia.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="eroxia.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
//echo $search3;
...
//https://www.youjizz.com/search/mature-mom-anal-1.html?
  ...
  curl_setopt($ch, CURLOPT_REFERER, "https://www.eroxia.com");
...
if ($page > 1)
echo '<a href="eroxia.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="eroxia.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="eroxia.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
...
$videos = explode('div class="item col',$html);
...
foreach($videos as $video) {
    ...
    $t1=explode('icon -time">',$video);
    $t2=explode('stat-label">',$t1[1]);
    $t3=explode("<",$t2[1]);
    $data=" (".$t3[0].")";
  if ($n==0) echo '<TR>';
  if ($flash != "mp") {
  $link = "eroxia_link.php?file=".$link."&title=".urlencode($title);
