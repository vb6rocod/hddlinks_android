...
echo '<TR><td style="color:black;background-color:#0a6996;color:#64c8ff;text-align:center" colspan="3"><font size="6"><b>4tube</b></TD></TR>';
echo '<TR><TD class="cat" colspan="1">'.'<a href="4tube.php?page=1,https://www.4tube.com/videos,Recente" target="_blank"><b>Recente</b></a></TD>';
echo '<TD class="form" colspan="2"><form action="4tube.php" target="_blank">Cautare <input type="hidden" name="page1" id="page1" value="1"><input type="text" id="src" name="src" value="'.$val_search.'"><input type="submit" value="send" id="send"></form></td>';
...
foreach($videos as $video) {
    ...
    $t3=explode('"',$t2[1]);
  	$title=$t3[0];
    $link="4tube.php?page=1,".$link.",".urlencode($title);
