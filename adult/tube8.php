...
if($tip=="release") {
  if ($page>1)
    $l = str_replace(" ","%20",$link)."page/".$page."/";
  else
    $l = str_replace(" ","%20",$link);
} else {
  $search=str_replace(" ","+",$tit);
  if ($page > 1)
    $l="https://www.tube8.com/searches.html?q=".$search."&page=".$page;
  else
    $l="https://www.tube8.com/searches.html?q=".$search;
}
