...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 //https://handjobhub.com/search/mom-son/page2.html
 $search3 = "https://handjobhub.com/search/".str_replace("+","-",$search1)."/page".$page1.".html";
}
?>
<html><head>
...
function ajaxrequest(title, link) {
  ...
  var php_file="handjobhub_link.php";
...
if ($page1) {
if ($page1 > 1)
echo '<a href="handjobhub.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="handjobhub.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="handjobhub.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
//echo $search3;
...
if ($page > 1)
echo '<a href="handjobhub.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="handjobhub.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="handjobhub.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
...
foreach($videos as $video) {
    ...
    $t2 = explode('"', $video);
    $link = "https://handjobhub.com/video/".$t2[0];
  ...
  if ($n==0) echo '<TR>';
  if ($flash != "mp") {
  $link = "handjobhub_link.php?file=".$link."&title=".urlencode($title);
