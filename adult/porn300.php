...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 //hhttps://www.porn300.com/search/?page=2&q=mom%20son
 $search3 = "https://www.porn300.com/search/?page=".$page1."&q=".$search1;
}
?>
<html><head>
...
if ($page1) {
if ($page1 > 1)
echo '<a href="porn300.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="porn300.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="porn300.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
//echo $search3;
...
if ($page > 1)
echo '<a href="porn300.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="porn300.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="porn300.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
//$html = file_get_contents($search."?page=".$page);
//https://www.porn300.com/videos/?page=2
...
$search3  = $search."?page=".$page;  //http://www.4tube.com/videos?p=2&sort=date
  ...
  curl_setopt($ch, CURLOPT_USERAGENT, 'Mozilla/5.0 (Windows; U; Windows NT 6.1; en-US; rv:1.9.1.2) Gecko/20090729 Firefox/3.5.2 GTB5');
  curl_setopt($ch, CURLOPT_FOLLOWLOCATION  ,1);
  curl_setopt($ch, CURLOPT_REFERER, "https://www.porn300.com/");
  curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
  curl_setopt($ch, CURLOPT_CONNECTTIMEOUT, 5);
  curl_setopt($ch, CURLOPT_TIMEOUT, 15);
  $html = curl_exec($ch);
...
foreach($videos as $video) {
    ...
    $t2 = explode('"', $t1[1]);
    $link = "https://www.porn300.com".$t2[0];
  ...
  if ($n==0) echo '<TR>';
  if ($flash != "mp") {
  $link = "porn300_link.php?file=".$link."&title=".urlencode($title);
