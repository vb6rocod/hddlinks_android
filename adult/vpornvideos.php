...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 //https://www.vpornvideos.com/tag/mom/0/2
 $search3 = "https://www.vpornvideos.com/tag/".$search1."/0/".$page1;
}
?>
<html><head>
...
function ajaxrequest(title, link) {
  ...
  var php_file="vpornvideos_link.php";
...
if ($page1) {
if ($page1 > 1)
echo '<a href="vpornvideos.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="vpornvideos.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="vpornvideos.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
//echo $search3;
...
//https://www.youjizz.com/search/mature-mom-anal-1.html?
  ...
  curl_setopt($ch, CURLOPT_REFERER, "https://www.vpornvideos.com/");
...
if ($page > 1)
echo '<a href="vpornvideos.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="vpornvideos.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="vpornvideos.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
...
foreach($videos as $video) {
  ...
  if ($n==0) echo '<TR>';
  if ($flash != "mp") {
  $link = "vpornvideos_link.php?file=".$link."&title=".urlencode($title);
