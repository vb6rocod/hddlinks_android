...
file_put_contents($base_cookie."adult.dat",urldecode($search1));
 ...
 $search="https://www.pornburst.xxx/search/page".$page1.".html?q=".$search1;
 if ($page1==1)
 $search="https://www.pornburst.xxx/search/?q=".$search1;
 else
 $search="https://www.pornburst.xxx/ajax/new_search/?page=".$page1."&q=".str_replace(" ","%20",$search1);
}
?>
<html><head>
...
if ($page1) {
if ($page1 > 1)
echo '<a href="pornburst.php?page1='.($page1-1).'&src='.$search1.'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="pornburst.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="pornburst.php?page1='.($page1+1).'&src='.$search1.'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
  $ch = curl_init();
...
if ($page > 1)
echo '<a href="pornburst.php?page='.($page-1).','.$search.','.urlencode($page_title).'">&nbsp;&lt;&lt;&nbsp;</a> | <a href="pornburst.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
else
echo '<a href="pornburst.php?page='.($page+1).','.$search.','.urlencode($page_title).'">&nbsp;&gt;&gt;&nbsp;</a></TD></TR>';
//$html = file_get_contents($search."page".$page.".html");
if ($page > 1) {
