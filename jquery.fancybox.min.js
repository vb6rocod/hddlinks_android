...
function xx(e){
 ...
 if (instance !== false) {
  var x=document.querySelector("iframe").id;
  var y=document.querySelector("iframe").src;
 if (charCode == "37") {
  document.getElementById(x).contentWindow.document.getElementById("imdb_d").innerHTML="";
  instance.showLoading();
  $.get("imdb_d.php?sens=minus", function(data){
    document.getElementById(x).contentWindow.document.getElementById("imdb_d").innerHTML=data;
  });
  instance.update();
  setTimeout(function(){ instance.hideLoading(); }, 1000);
 } else if (charCode == "39") {
  document.getElementById(x).contentWindow.document.getElementById("imdb_d").innerHTML="";
  instance.showLoading();
  $.get("imdb_d.php?sens=plus", function(data){
    document.getElementById(x).contentWindow.document.getElementById("imdb_d").innerHTML=data;
  });
  instance.update();
  setTimeout(function(){ instance.hideLoading(); }, 1000);
